    ...
    <header class="header">
        ...
        <div class="slideshow-container">
            <div class="mySlides fade">
                <img src="./assets/img/header.png" style="width:100%" alt="products">
                <!-- <div class="text">Caption Text</div> -->
                <div class="slideshow-container__content">
                    <h3>100% plant based</h3>
                    <h2>Good Hair Day?</h2>
                    <p>Vegan, all natural hair products that don't cost the earth.</p>
                    <a href="#" class="button button--dark">Shop Now</a>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="./assets/img/header-2.png" style="width:100%" alt="products">
                <div class="slideshow-container__content">
                    <h3>100% Natural</h3>
                    <h2>More avo, less plastic</h2>
                    <p>Our products make the most of what Mother Nature has to offer.</p>
                    <a href="#" class="button button--dark">Shop Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <section class="promo-card">
                <div class="promo-card__content">
                    <a href="#">
                        <img src="./assets/img/travel_collection_2100x.png" alt="travel collection">
                    </a>
                ...
                <div class="promo-card__content">
                    <a href="#">
                        <img src="./assets/img/love_collection_2100x.png" alt="love collection">
                    </a>
            ...
            <section class="subscription-section">
                <div class="full-width">
                    <img src="./assets/img/jessica-felicio-_cvwXhGqG-o-unsplash_1200x.jpg" alt="jessica felicio">
                </div>
                ...
                <div class="blog-section__article">
                    <article class="blog-content">
                        <div class="blog-content__article-img">
                            <img src="./assets/img/Blog_image_1_2x_1800x_79df387a-0188-4e66-8a9f-fe4f9c455041_1500x.png.jpg" alt="travel collection">
                        </div>
                        ...
                        <!-- <article class="blog-content">
                            <div class="blog-content__article-img">
                                <img src="./assets/img/blog-image.jpg" alt="travel collection">
                            </div>
                            <h3 class="blog-content__heading">City guide : Santa barbara</h3>
                            <span class="blog-content__date indiv--date">January 05, 2019</span>
                            <div class="blog-content__excerpt">
